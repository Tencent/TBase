...
GuessControlValues(void)
{
    ...
    ControlFile.checkPointCopy.latestCommitTs = InvalidGlobalTimestamp;
    ControlFile.checkPointCopy.latestGTS       = InvalidGlobalTimestamp;
#endif
...
#ifdef __SUPPORT_DISTRIBUTED_TRANSACTION__
    printf(_("Latest checkpoint's LatestCommitTs:     \n" INT64_FORMAT),
           ControlFile.checkPointCopy.latestCommitTs);
    printf(_("Latest checkpoint's LatestGTS:     \n" INT64_FORMAT),
