...
static const struct cachedesc cacheinfo[] = {
...
#ifdef _MLS_
    {ClsCompartmentRelationId,    /* CLSCOMOID */
        PgClsCompartmentPolidCompartmentidIndexId,
        2,
        {
            Anum_pg_cls_compartment_polid,
            Anum_pg_cls_compartment_compartmentid,
            0,
            0
        },
        128
    },
    {ClsGroupRelationId,    /* CLSGRPOID */
    ...
    {ClsLevelRelationId,    /* CLSLEVELOID */
        PgClsLevelPolidLevelidIndexId,
        2,
        {
            Anum_pg_cls_level_polid,
            Anum_pg_cls_level_levelid,
            0,
            0
        },
        128
    },
    {ClsPolicyRelationId,    /* CLSPOLOID */
        PgClsPolicyPolidNameIndexId,
        2,
        {
            Anum_pg_cls_policy_polid,
            Anum_pg_cls_policy_polname,
            0,
            0
        },
        128
    },
    {ClsTableRelationId,    /* CLSTBLOID */
        PgClsTablePolidRelidIndexId,
        3,
        {
            Anum_pg_cls_table_polid,
            Anum_pg_cls_table_attnum,
            Anum_pg_cls_table_relid,
            0
        },
        128
    },
    {ClsUserRelationId,        /* CLSUSEROID */
        PgClsUserPolidUseridIndexId,
        2,
        {
            Anum_pg_cls_user_polid,
    ...
    {PgPartitionIntervalRelationId,    /* PGPARTITIONINTERVALREL*/
        ...
        1,
        {
            Anum_pg_partition_interval_partrelid,
            0,
            0,
            0
        },
...
#ifdef __COLD_HOT__
    {PgxcKeyValueRelationId,        /* SHARDKEYVALUE */
        PgxcShardKeyValuesIndexID,
        3,
        {
            Anum_pgxc_key_valuew_db,
            Anum_pgxc_key_values_rel,
            Anum_pgxc_key_value_value,
            0
        },
        128
    },
...
#ifdef _MLS_
    {TransparentCryptPolicyAlgorithmId,        /* TCPALGORITHM */
        PgTransparentCryptPolicyAlgorithmIndexId,
        2,
        {
            Anum_pg_transparent_crypt_policy_algorithm_id,
            Anum_pg_transparent_crypt_policy_algorithm_name,
            0,
            0,
        },
        32
    },
    {TransparentCryptPolicyMapRelationId,        /* TCPOID */
        PgTransparentCryptPolicyMapIndexId,
        3,
        {
            Anum_pg_transparent_crypt_policy_map_relid,
            Anum_pg_transparent_crypt_policy_map_attnum,
            Anum_pg_transparent_crypt_policy_map_algorithm,
            0,
        },
        128
    },
    {TransparentCryptPolicySchemaRelationId,        /* TCPSOID */
        PgTransparentCryptPolicySchemaIndexId,
        2,
        {
            Anum_pg_transparent_crypt_policy_schema_schemaoid,
            Anum_pg_transparent_crypt_policy_schema_algorithm,
            0,
            0,
        },
        32
    },
    {TransparentCryptPolicyTablespaceRelationId,        /* TCPTOID */
        PgTransparentCryptPolicyTablespaceIndexId,
        2,
        {
            Anum_pg_transparent_crypt_policy_spc_spcoid,
            Anum_pg_transparent_crypt_policy_spc_algorithm,
            0,
            0,
        },
        32
