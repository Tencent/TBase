...
#ifdef _PG_ORCL_
static Datum orcl_timestamp_pl_day_internal(Timestamp dt, float8 days);
static Datum orcl_timestamp_mi_day_internal(Timestamp dt, float8 days);
#endif
...
{
    PG_RETURN_TIMESTAMP(GetSQLLocalTimestamp(0));
}

Datum 
orcl_systimestamp(PG_FUNCTION_ARGS)
{
    PG_RETURN_TIMESTAMPTZ(GetCurrentTimestamp());
}
#endif
...
#ifdef _PG_ORCL_
Datum
orcl_timestamp_mi(PG_FUNCTION_ARGS)
{
    Timestamp    dt1 = PG_GETARG_TIMESTAMP(0);
    Timestamp    dt2 = PG_GETARG_TIMESTAMP(1);
    float8       result = 0;
    ...
    result = ((float8)(dt1 * 1.0 - dt2 * 1.0)) / (USECS_PER_DAY);
...
#ifdef _PG_ORCL_
            if (enable_oracle_compatible && last_day)
            {
                tm->tm_mday = (day_tab[isleap(tm->tm_year)][tm->tm_mon - 1]);
            }
#endif
...
static Datum
orcl_timestamp_pl_day_internal(Timestamp dt, float8 days)
{
    Timestamp result;
...
Datum
orcl_timestamp_pl_day_i2(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
    int16        arg2 = PG_GETARG_INT16(1);
    float8         days = DatumGetFloat8(DirectFunctionCall1(i2tod, Int16GetDatum(arg2)));

    return orcl_timestamp_pl_day_internal(arg1, days);
}

Datum
orcl_timestamp_pl_day_i4(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
...
Datum
orcl_timestamp_pl_day_i8(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
...
Datum
orcl_timestamp_pl_day_n(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
...
static Datum
orcl_timestamp_mi_day_internal(Timestamp dt, float8 days)
{
    Timestamp        result;
...
Datum
orcl_timestamp_mi_day_i2(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
    int16        arg2 = PG_GETARG_INT16(1);
    float8         days = DatumGetFloat8(DirectFunctionCall1(i2tod, Int16GetDatum(arg2)));

    return orcl_timestamp_mi_day_internal(arg1, days);
}

Datum
orcl_timestamp_mi_day_i4(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
    int32        arg2 = PG_GETARG_INT32(1);
    float8         days = DatumGetFloat8(DirectFunctionCall1(i4tod, Int32GetDatum(arg2)));
...
Datum
orcl_timestamp_mi_day_i8(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
    int64        arg2 = PG_GETARG_INT64(1);
    float8         days = DatumGetFloat8(DirectFunctionCall1(i8tod, Int64GetDatum(arg2)));
...
Datum
orcl_timestamp_mi_day_n(PG_FUNCTION_ARGS)
{
    Timestamp     arg1 = PG_GETARG_TIMESTAMP(0);
    Numeric        arg2 = PG_GETARG_NUMERIC(1);
    float8         days = DatumGetFloat8(DirectFunctionCall1(numeric_float8, NumericGetDatum(arg2)));
