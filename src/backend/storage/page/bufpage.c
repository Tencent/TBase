 ...
 */
void
PageInit_shard(Page page, Size pageSize, Size specialSize, ShardID sid, bool nohole)
{
...
#ifdef _MLS_
    p->pd_algorithm_id = TRANSP_CRYPT_INVALID_ALGORITHM_ID;
#endif
...
#ifdef _SHARDING_
void
PageClean(Page page, Size pageSize)
{
