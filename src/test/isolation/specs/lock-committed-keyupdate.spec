...
setup
{
    CREATE TABLE lcku_table (seq int, id INTEGER PRIMARY KEY, value TEXT);
}
setup
{
    INSERT INTO lcku_table VALUES (1, 1, 'one');
    INSERT INTO lcku_table VALUES (2, 3, 'two');
}
...
step "s2b3"    { BEGIN ISOLATION LEVEL REPEATABLE READ; }
