...
SELECT * FROM itest1 order by 1;
SELECT * FROM itest2 order by 1;
SELECT * FROM itest3 ORDER BY a;
SELECT * FROM itest4 order by 1;
...
SELECT * FROM itestv10 order by 1;
SELECT * FROM itestv11 order by 1;
...
SELECT * FROM itest7c order by 1;
