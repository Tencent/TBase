...
CREATE MATERIALIZED VIEW mvtest_tvm AS SELECT * FROM mvtest_tv ORDER BY type;
SELECT * FROM mvtest_tvm order by 1;
...
SELECT * FROM mvtest_tmm order by 1;
SELECT * FROM mvtest_tvmm order by 1;
SELECT * FROM mvtest_tvvm order by 1;
...
SELECT * FROM mvtest_mv_v_2 order by 1;
SELECT * FROM mvtest_mv_v_3 order by 1;
SELECT * FROM mvtest_mv_v_4 order by 1;
...
$$ LANGUAGE plpgsql;
SELECT mvtest_func();
SELECT * FROM mvtest1 order by 1;
SELECT * FROM mvtest2 order by 1;
ROLLBACK;
