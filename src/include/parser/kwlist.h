...
PG_KEYWORD("begin_subtxn", BEGIN_SUBTXN, UNRESERVED_KEYWORD)
...
PG_KEYWORD("commit_subtxn", COMMIT_SUBTXN, UNRESERVED_KEYWORD)
...
#ifdef _PG_ORCL_
PG_KEYWORD("dbtimezone", DBTIMEZONE, RESERVED_KEYWORD)
#endif
...
#ifdef _SHARDING_
PG_KEYWORD("extent", EXTENT, UNRESERVED_KEYWORD)
#endif
...
#ifdef _PG_ORCL_
PG_KEYWORD("number", NUMBER, COL_NAME_KEYWORD)
#endif
...
#ifdef __TBASE__
PG_KEYWORD("oid", OID_P, UNRESERVED_KEYWORD)
#endif
...
PG_KEYWORD("rollback_subtxn", ROLLBACK_SUBTXN, UNRESERVED_KEYWORD)
...
*/
PG_KEYWORD("step", STEP, UNRESERVED_KEYWORD)
/* 
...
*/
PG_KEYWORD("tbase", TBASE_P, UNRESERVED_KEYWORD)
#endif
...
* tbase related
*/
PG_KEYWORD("unlock", UNLOCK_P, UNRESERVED_KEYWORD)
#endif
