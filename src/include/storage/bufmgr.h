...
#ifdef _SHARDING_
extern Buffer ReadBufferForRedoExtentTable(SMgrRelation smgr, 
                        BlockNumber blockNum, ReadBufferMode mode);
#endif
...
#ifdef _SHARDING_
extern void DropRelfileNodeShardBuffers(RelFileNode rnode, ShardID sid);
extern void DropRelfileNodeExtentBuffers(RelFileNode rnode, ExtentID eid);
#endif
...
#ifdef _MLS_
extern void AbortBufferIOParellel(void);
#endif
