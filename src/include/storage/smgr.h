...
#ifdef _SHARDING_
    //ShardTargBlock smgr_shard_targblocks[SMGR_TARGBLOCK_MAX_SHARDS];
    //int            smgr_shard_tb_lasthit;
    BlockNumber smgr_shard_targblocks[SMGR_TARGBLOCK_MAX_SHARDS];    
